	...
	*/
	...
	public static int login(String user, String pa){
		...
		try{
			...
			System.out.println("This an URL "+ connectionUrl);
	...
	public static ResultSet ejecutarQueryPrepared(String sentenciaSQL, Object [] parametros)throws Exception{		
		try{		
			stat = con.prepareStatement(sentenciaSQL, Statement.RETURN_GENERATED_KEYS);
	...
	public static ResultSet getGeneratedKeys(){
